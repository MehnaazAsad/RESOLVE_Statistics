...
def lnprob(theta, phi, err_tot):
    ...
    try:
        ...
        max_model, phi_model, err_tot_model, bins_model =\
            diff_bmf(mstellar_mock, v_sim, 0, True)
...
chain_fname = path_to_proc + 'mcmc_eco_bary.dat'
...
data = sampler.chain
with open(path_to_proc + 'mcmc_eco_bary_raw.txt', 'w') as outfile:
...
fname = path_to_proc + 'eco_bary_chi2.txt'
