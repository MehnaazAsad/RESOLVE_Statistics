...
### Baryonic mass of just centrals for HAM
mbary_c = (10**(centrals_resolve.logmstar.values) + 10**(centrals_resolve.logmgas.values))
nbins = num_bins(mbary_c)
bin_centers_mbaryc,bin_edges_mbaryc,n_mbaryc,err_poiss_mbaryc,bin_width_mbaryc = \
cumu_num_dens(mbary_c,nbins,None,v_resolve,False)

### Group integrated stellar mass for HAM
grpms = 10**(resolve_live18.grpms.values)
...
### Stellar mass of just centrals for HAM
mstar_c = 10**(centrals_resolve.logmstar.values)
nbins = num_bins(mstar_c)
bin_centers_mstarc,bin_edges_mstarc,n_mstarc,err_poiss_mstarc,bin_width_mstarc = \
cumu_num_dens(mstar_c,nbins,None,v_resolve,False)
...
bin_centers_hmassc,bin_edges_hmassc,n_hmassc,err_poiss_hmassc,bin_width_hmassc = \
cumu_num_dens(halo_mass_c,nbins,None,v_sim,False)
...
mbaryc_n_interp_func = interpolate.interp1d(bin_centers_mbaryc,n_mbaryc,fill_value='extrapolate')

### Interpolating between grpmstar and n
grpms_n_interp_func = interpolate.interp1d(bin_centers_grpms,n_grpms,fill_value='extrapolate')
### Interpolating between central mstar and n
mstarc_n_interp_func = interpolate.interp1d(bin_centers_mstarc,n_mstarc,fill_value='extrapolate')
...
### Get error bars
x_mbaryc,y_mbaryc,y_std_mbaryc,y_std_err_mbaryc = Stats_one_arr(hmass_logmbaryc,logmbaryc,\
                                                            base=0.5)
x_grpmb,y_grpmb,y_std_grpmb,y_std_err_grpmb = Stats_one_arr(hmass_loggrpmb,loggrpmb,\
                                                            base=0.5)

x_mstarc,y_mstarc,y_std_mstarc,y_std_err_mstarc = Stats_one_arr(hmass_logmstarc,logmstarc,\
                                                            base=0.5)
x_grpms,y_grpms,y_std_grpms,y_std_err_grpms = Stats_one_arr(hmass_loggrpms,loggrpms,\
                                                            base=0.5)

x_mhs,y_mhs,y_std_mhs,y_std_err_mhs = Stats_one_arr(resolve_live18.logmh_s.values,resolve_live18.grpmb.values,\
                                                            base=0.5)
x_mh,y_mh,y_std_mh,y_std_err_mh = Stats_one_arr(resolve_live18.logmh.values,resolve_live18.grpmb.values,\
                                                            base=0.5)
### Plotting BMHM and SMHM from HAM
fig1 = plt.figure(figsize=(10,10))
plt.scatter(hmass_loggrpmb,loggrpmb,color='#1baeab',s=5)
...
x_mhs,y_mhs,y_std_mhs,y_std_err_mhs = Stats_one_arr(resolve_live18.logmh_s.values,resolve_live18.grpms.values,\
                                                            base=0.5)
...
mstar_n_interp_func = interpolate.interp1d(bin_centers_mstar,n_mstar,fill_value='extrapolate')
...
x_mstar,y_mstar,y_std_mstar,y_std_err_mstar = Stats_one_arr(hmass_logmstar,logmstar,\
                                                            base=0.5)
...
x_mhs,y_mhs,y_std_mhs,y_std_err_mhs = Stats_one_arr(resolve_live18.logmh_s.values,resolve_live18.logmstar.values,\
                                                            base=0.5)
