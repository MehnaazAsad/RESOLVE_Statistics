...
chi2_file = path_to_proc + 'smhm_colour_run15/{0}_colour_chi2.txt'.\
    format(survey)
chain_file = path_to_proc + 'smhm_colour_run15/mcmc_{0}_colour_raw.txt'.\
    format(survey)
randint_file = path_to_proc + 'smhm_colour_run15/{0}_colour_mocknum.txt'.\
    format(survey)
