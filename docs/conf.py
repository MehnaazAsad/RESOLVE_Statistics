...
# -*- coding: utf-8 -*-
#
# RESOLVE Statistics documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'resolve_statisticsdoc'
...
texinfo_documents = [
    ('index', 'resolve_statistics', u'RESOLVE Statistics Documentation',
     u"Mehnaaz Asad", 'RESOLVE Statistics',
     'Statistically infer BMHM and SMHM relation for RESOLVE', 'Miscellaneous'),
]
